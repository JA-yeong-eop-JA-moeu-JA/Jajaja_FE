...
const navItems = [
  ...
  { to: '/shoppingcart', icon: cartFillIcon, activeIcon: cartFillIcon, label: '장바구니' },
  { to: '/mypage', icon: myIcon, label: '마이페이지' },
];
export default function BottomBar() {
  return (
    <div className="fixed bottom-0 left-0 right-0 w-full bg-white z-50">
      <nav className="mx-auto w-full max-w-[600px] grid grid-cols-5 px-2 py-2 text-tiny-medium h-14">
